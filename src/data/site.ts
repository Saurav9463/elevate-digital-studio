...
export const projects: Project[] = [
  { id: "spice-route-restaurant", slug: "spice-route-restaurant", title: "Spice Route Restaurant", category: "Restaurant", client: "Spice Route, Delhi", summary: "Reservation-first website with multilingual menu, gallery, and direct WhatsApp ordering. Increased weekday bookings by 38%.", tech: ["React", "TypeScript", "Tailwind"], is_featured: true, year: "2025", live_url: "#", cover_url: null, gradient: "from-amber-100 via-rose-100 to-orange-100" },
  { id: "luxe-salon-booking", slug: "luxe-salon-booking", title: "Luxe Salon — Booking System", category: "Salon", client: "Luxe Salon & Spa", summary: "End-to-end appointment system with stylist availability, SMS reminders, and an owner dashboard for daily operations.", tech: ["React", "Node.js", "Express", "Twilio"], is_featured: true, year: "2025", live_url: "#", cover_url: null, gradient: "from-rose-100 via-pink-100 to-purple-100" },
  { id: "northcare-clinic", slug: "northcare-clinic", title: "NorthCare Clinic", category: "Clinic", client: "NorthCare Medical", summary: "A calm, trust-first clinic website with doctor profiles, services, and patient appointment requests routed to staff.", tech: ["React", "TypeScript", "Tailwind"], is_featured: true, year: "2024", live_url: "#", cover_url: null, gradient: "from-sky-100 via-blue-100 to-cyan-100" },
  { id: "iron-forge-gym", slug: "iron-forge-gym", title: "Iron Forge Gym", category: "Gym", client: "Iron Forge Strength Co.", summary: "Bold website for a strength gym with class schedules, trainer bios, and free trial lead capture.", tech: ["React", "Framer Motion"], year: "2024", live_url: "#", cover_url: null, gradient: "from-zinc-200 via-neutral-200 to-stone-200" },
  { id: "metric-business-dashboard", slug: "metric-business-dashboard", title: "Metric — Business Dashboard", category: "Dashboard", client: "Metric Retail Group", summary: "Custom admin dashboard unifying sales, inventory, and staff across 6 retail locations with role-based access.", tech: ["React", "TypeScript", "Node.js", "Recharts"], is_featured: true, year: "2025", live_url: "#", cover_url: null, gradient: "from-blue-100 via-indigo-100 to-violet-100" },
  { id: "videotube", slug: "videotube", title: "Videotube", category: "Web App", client: "Internal product", summary: "Full-stack video platform with channels, subscriptions, playlists, and watch history — built end-to-end.", tech: ["React", "Node.js", "Express", "MongoDB"], year: "2024", live_url: "#", cover_url: null, gradient: "from-red-100 via-orange-100 to-amber-100" },
  { id: "atelier-portfolio", slug: "atelier-portfolio", title: "Atelier — Portfolio Site", category: "Portfolio", client: "Atelier Studio", summary: "Editorial portfolio for an interior design studio with project case studies and inquiry form.", tech: ["React", "TypeScript", "Tailwind"], year: "2024", live_url: "#", cover_url: null, gradient: "from-stone-100 via-neutral-100 to-zinc-100" },
  { id: "greenleaf-yoga", slug: "greenleaf-yoga", title: "Greenleaf Yoga Studio", category: "Studio", client: "Greenleaf Yoga", summary: "Calm, conversion-focused studio website with class booking and instructor pages.", tech: ["React", "Tailwind"], year: "2024", live_url: "#", cover_url: null, gradient: "from-emerald-100 via-green-100 to-teal-100" },
];
