  ...
  head: () => ({
    meta: [
      { title: "Elevate Web Solutions — Websites that help local businesses grow" },
      {
        name: "description",
        content:
          "Custom websites, booking systems, and business dashboards for restaurants, salons, clinics, gyms, and local businesses.",
      },
      { property: "og:title", content: "Elevate Web Solutions" },
      {
        property: "og:description",
        content:
          "Custom websites, booking systems, and business dashboards for local businesses.",
      },
    ],
  }),
  component: Home,
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="container-page pt-20 pb-24 md:pt-28 md:pb-32">
          ...
          <motion.h1
            ...
            className="mt-6 max-w-4xl text-4xl font-semibold leading-[1.05] tracking-tight text-foreground md:text-6xl"
          >
            We build websites that help{" "}
            <span className="text-accent">local businesses</span> grow.
          </motion.h1>
          ...
          >
            Professional websites, booking systems, and business dashboards
            designed to help you attract more customers and run a calmer business.
          </motion.p>
          ...
          <div className="flex flex-col items-start justify-between gap-4 md:flex-row md:items-end">
            <div>
              ...
              <h2 className="mt-4 max-w-xl text-3xl font-semibold tracking-tight md:text-4xl">
                Everything a local business needs online.
              </h2>
            </div>
        ...
        <div className="container-page grid gap-12 lg:grid-cols-[1fr_1.2fr]">
          <div>
            ...
            <h2 className="mt-4 text-3xl font-semibold tracking-tight md:text-4xl">
              A studio that treats your business like our own.
            </h2>
            <p className="mt-4 max-w-md text-muted-foreground">
              We're small on purpose. Two senior founders working directly with you —
              no junior handoffs, no inflated overhead.
            </p>
            <Link to="/about" className="mt-6 inline-flex text-sm font-medium text-accent hover:underline">
              Meet the founders →
            </Link>
          </div>
      ...
      <section className="section border-t border-border">
        <div className="container-page">
          <div className="relative overflow-hidden rounded-3xl border border-border bg-foreground px-8 py-14 text-background md:px-14 md:py-20">
            <div className="relative z-10 grid gap-8 md:grid-cols-[1.4fr_1fr] md:items-center">
              <div>
                ...
                <p className="mt-3 max-w-xl text-background/70">
                  ...
                  presence and outline a plan — no pressure, no obligation.
                </p>
              </div>
              <div className="flex flex-wrap gap-3 md:justify-end">
                <Link
                  to="/contact"
                  className="inline-flex items-center justify-center gap-2 rounded-lg bg-accent px-5 py-3 text-sm font-medium text-accent-foreground transition-all hover:brightness-110"
                >
                  Book consultation <ArrowRight className="h-4 w-4" />
                </Link>
                <Link
                  to="/projects"
                  className="inline-flex items-center justify-center gap-2 rounded-lg border border-background/20 px-5 py-3 text-sm font-medium text-background hover:bg-background/10"
                >
                  See our work
                </Link>
              </div>
            ...
            <div
              aria-hidden
              className="pointer-events-none absolute -right-32 -top-32 h-80 w-80 rounded-full bg-accent/30 blur-3xl"
            />
          </div>
        </div>
      </section>
