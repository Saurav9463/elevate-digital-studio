  ...
  head: () => ({
    meta: [
      { title: "Services — Elevate Web Solutions" },
      {
        name: "description",
        content:
          "Websites, booking systems, dashboards, and custom web apps for restaurants, salons, clinics, gyms, and local businesses.",
      },
      { property: "og:title", content: "Services — Elevate Web Solutions" },
      {
        property: "og:description",
        content:
          "Websites, booking systems, dashboards, and custom web apps for local businesses.",
      },
    ],
  }),
      ...
      <section className="section border-t border-border">
        <div className="container-page text-center">
          ...
          <p className="mx-auto mt-4 max-w-xl text-muted-foreground">
            Tell us about your business. We'll recommend the right scope and budget — no pressure.
          </p>
