  ...
  head: () => ({
    meta: [
      { title: "Testimonials — Elevate Web Solutions" },
      {
        name: "description",
        content:
          "What restaurant, salon, clinic, and gym owners say about working with Elevate Web Solutions.",
      },
      { property: "og:title", content: "Testimonials — Elevate Web Solutions" },
      {
        property: "og:description",
        content: "Reviews from real businesses we've worked with.",
      },
    ],
  }),
            ...
            {testimonials.map((t, i) => (
              ...
              >
                <div className="flex items-center justify-between">
                  ...
                  <span className="rounded-full border border-border bg-surface-muted px-2.5 py-0.5 text-[11px] text-muted-foreground">
                    {t.business}
                  </span>
                </div>
