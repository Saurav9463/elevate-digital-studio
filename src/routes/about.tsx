  ...
  head: () => ({
    meta: [
      { title: "About — Elevate Web Solutions" },
      {
        name: "description",
        content:
          "Meet Saurav Arora and Raman Kumar, the founders of Elevate Web Solutions — a two-person studio building modern websites and web apps.",
      },
      { property: "og:title", content: "About — Elevate Web Solutions" },
      {
        property: "og:description",
        content:
          "Meet the founders behind Elevate Web Solutions — a boutique two-person web studio.",
      },
    ],
  }),
  component: AboutPage,
  ...
  return (
    <PageShell>
      <PageHeader
        ...
        description="Elevate Web Solutions was founded by Saurav Arora and Raman Kumar to bring agency-grade design and engineering to local businesses — without the agency overhead."
      />
      ...
      <section className="section border-t border-border bg-surface-muted/40">
        <div className="container-page">
          ...
          <p className="mt-3 max-w-2xl text-muted-foreground">
            We pick tools that make your product fast today and easy to evolve tomorrow.
          </p>
          <div className="mt-10 flex flex-wrap gap-2">
            {technologies.map((t) => (
              <span
                key={t}
                className="rounded-lg border border-border bg-surface px-3.5 py-1.5 text-sm text-foreground"
              >
                {t}
              </span>
            ))}
